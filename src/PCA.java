...
public class PCA extends FeatureExtraction {
	...
	public PCA(ArrayList<Matrix> trainingSet, ArrayList<String> labels, int numOfComponents){
		...
		for(int i = 0; i < trainingSet.size(); i ++){
			projectedTrainingMatrix ptm = new projectedTrainingMatrix(this.W.transpose().times(trainingSet.get(i).minus(meanMatrix)),labels.get(i));
